...
```{r}
pacman::p_load(tidyverse, magrittr, stringi, qdapRegex, purrr, here, tuber, lubridate, SocialMediaLab)
...
video_list <- readr::read_file("text/mw.txt")
video_list %<>% 
...
```{r}
mw_ids  <- get_video_ids("text/mw.txt")
...
## Try 1
mw_comments <- extract_comments(mw_ids$yt_code, 1, "mw")
