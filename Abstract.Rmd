...
We gathered 1.3 Million comments from several Alt-Right Network Hubs and Figureheads on Facebook (for example Infowars, Milo Yiannopolis, Mike Cernovich, Paul Jospeh Watson and others) over the course of one year (07.12.2016 - 07/12/2017). As a first step, we cleaned the data using lemmatization and removed common irrelevant words. Next, we applied sentiment analysis to identify hateful and angry comments, leaving us with a dataset of the kind of polarizing commentary that is relevant for our analysis. Moreover, we used topic modelling in order to pinpoint Alt Right talking points (for example "race realism", "anti-feminism", "fake news" and more) resulting in a text corpus where the relevant Alt Right narratives have been isolated. 

We then proceed to map the cleaned Alt Right corpus on the comment sections of several news page outlets on Facebook using a measure of cosinus similarity. We find that Alt Right discourse is mostly found on Fox News and Breitbart but can also be traced to less expected outlets such as CNN and ABC.  
