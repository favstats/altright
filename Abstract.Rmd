...
The purpose of this research is to track Alt-Right discourse on Facebook and extract psychometric and linguistic features of their online commentary. More specifically, we aim to identify content that aligns with Alt-Right discussion patterns in the Facebook comment sections of different media outlets (e. g. CNN, Breitbart, FOX News etc.). With this research we hope to gain insights into how the Alt Right communicates online and contribute to an automated content identification system.

We webscraped the online commentary from several Alt-Right Network Hubs and Figureheads on Facebook (for example Infowars, Milo Yiannopolis, Mike Cernovich, Paul Jospeh Watson and others) over the course of one year (07.12.2016 - 07/12/2017). We clean the data with the two following methods: 1) using topic modelling, we were able to identify the most common issues discussed (for example race, anti-feminism, fake news and more) and 2) using sentiment analysis to identify hateful comments towards Jewish people, Muslims and non-white people. This allowed us to clean the data of noise, leaving us with a corpus of comments across the different Alt Right network hubs, which can be seen as the core talking points of Alt Right discourse. We then proceed to map the cleaned Alt Right corpus on several news page outlets on Facebook and establish connections between the comment section and Alt Right commentary. We find that the discourse is mostly associated with anger and disappointment and that FOX News and Breitbart have the highest similarity between corpi.

by the means of sentiment analysis we identify hate speech

cosinus similarity between the different commentaries
